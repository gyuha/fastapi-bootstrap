...
Provides the :func:`~fastapi_bootstrap.infra.llm.provider_factory.make_chat_litellm`
...
a :class:`~fastapi_bootstrap.domains.chat.ports.LLMClientProtocol` abstraction
instead.
"""
