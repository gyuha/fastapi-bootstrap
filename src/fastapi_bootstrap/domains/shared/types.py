...
Usage::
    ...
    from fastapi_bootstrap.domains.shared.types import UserId, ConversationId
...
#: Identity of a :class:`~fastapi_bootstrap.domains.auth.models.User` aggregate.
UserId = NewType("UserId", uuid.UUID)

#: Identity of a :class:`~fastapi_bootstrap.domains.auth.models.Role`.
RoleId = NewType("RoleId", uuid.UUID)

#: Identity of a :class:`~fastapi_bootstrap.domains.auth.models.Permission`.
PermissionId = NewType("PermissionId", uuid.UUID)


#: Identity of a :class:`~fastapi_bootstrap.domains.chat.models.Conversation` aggregate.
ConversationId = NewType("ConversationId", uuid.UUID)

#: Identity of a :class:`~fastapi_bootstrap.domains.chat.models.Message`.
