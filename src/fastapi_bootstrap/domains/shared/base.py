...
:class:`~fastapi_bootstrap.core.database.Base`.  ORM models live in each domain's
...
Usage::
    ...
    from fastapi_bootstrap.domains.shared.base import Entity, ValueObject
...
class Entity:
    ...
    :class:`~fastapi_bootstrap.core.database.Base` directly.
