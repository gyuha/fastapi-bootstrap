...
consumer of :class:`~fastapi_bootstrap.domains.chat.ports.AbstractLLMPort`
...
* :mod:`fastapi_bootstrap.domains.chat.ports` — the abstract port defined by the
  chat domain itself.
...
It does **not** import :class:`~fastapi_bootstrap.domains.chat.llm_client.LLMClient`
...
class ChatService:
    ...
    This class depends **only** on :class:`~fastapi_bootstrap.domains.chat.ports.AbstractLLMPort`
    ...
    * The domain layer has **zero runtime imports** from any LLM provider library.
    ...
    ----------
    llm_client:
        Any object satisfying :class:`~fastapi_bootstrap.domains.chat.ports.AbstractLLMPort`.
        In production this is an :class:`~fastapi_bootstrap.domains.chat.llm_client.LLMClient`
