...
* :class:`LLMClient` — a thin, provider-agnostic wrapper around
  ...
  :class:`~fastapi_bootstrap.domains.chat.ports.LLMClientProtocol`.

* :class:`DefaultLLMClientFactory` — the production implementation of
  :class:`~fastapi_bootstrap.domains.chat.ports.LLMClientFactoryProtocol`.
  Its single method ``get_llm_client()`` reads
  :class:`~fastapi_bootstrap.core.config.LLMSettings` and returns a
...
Usage::
    ...
    from fastapi_bootstrap.domains.chat.llm_client import get_llm_client
...
def get_llm_client() -> LLMClient:
    ...
    :class:`~fastapi_bootstrap.domains.chat.ports.LLMClientProtocol`, not the
