...
from fastapi_bootstrap.domains.auth.security import get_current_user, require_permission
from fastapi_bootstrap.domains.chat.container import get_chat_service
from fastapi_bootstrap.domains.chat.repository import ChatRepository
from fastapi_bootstrap.domains.chat.schemas import (
    ConversationCreate,
