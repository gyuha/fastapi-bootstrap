...
Entry points for uvicorn:
    ...
    uv run uvicorn fastapi_bootstrap.main:app \\
        ...
        --reload --reload-dir src/fastapi_bootstrap
...
from fastapi_bootstrap.core.logging import configure_logging
from fastapi_bootstrap.core.middleware import CorrelationIdMiddleware
...
def _register_routers(application: FastAPI) -> None:
    ...
    async def ready(response: Response) -> dict[str, str]:
        ...
        async def _check_database() -> None:
            ...
            from fastapi_bootstrap.core.database import engine
...
# ---------------------------------------------------------------------------
# Direct execution — ``python -m fastapi_bootstrap``
# ---------------------------------------------------------------------------
...
#   uv run uvicorn fastapi_bootstrap.main:app --workers 4
#
