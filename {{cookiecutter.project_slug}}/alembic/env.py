...
:class:`~{{ cookiecutter.package_name }}.core.config.Settings`).
...
def _get_sync_db_url() -> str:
    ...
    try:
        from {{ cookiecutter.package_name }}.core.config import Settings  # noqa: PLC0415
...
try:
    ...
    logger.warning(
        "Could not import {{ cookiecutter.package_name }}.core.database — "
