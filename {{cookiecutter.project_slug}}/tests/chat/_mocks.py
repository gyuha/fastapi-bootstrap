...
class StubLLMClient:
    """Minimal :class:`~{{ cookiecutter.package_name }}.domains.chat.ports.LLMClientProtocol` satisfier.
    ...
    :class:`~{{ cookiecutter.package_name }}.domains.chat.service.ChatService` during tests.
