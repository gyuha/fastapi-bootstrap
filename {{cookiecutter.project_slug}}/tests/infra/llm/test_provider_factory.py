...
:mod:`{{ cookiecutter.package_name }}.infra.llm.provider_factory`:
...
_PROVIDER_FACTORY_PATH = "{{ cookiecutter.package_name }}.infra.llm.provider_factory.ChatLiteLLM"
...
class TestSettingsNoneFallback:
    ...
    def test_none_settings_reads_from_get_settings(self) -> None:
        ...
        _GET_SETTINGS = "{{ cookiecutter.package_name }}.infra.llm.provider_factory.get_settings"
...
class TestInfraLayerIsolation:
    ...
    def test_provider_factory_module_has_no_domain_imports(self) -> None:
        ...
        """
        import {{ cookiecutter.package_name }}.infra.llm.provider_factory as factory_module
    ...
    def test_provider_factory_module_exports_make_chat_litellm(self) -> None:
        ...
        from {{ cookiecutter.package_name }}.infra.llm.provider_factory import make_chat_litellm as fn  # noqa: F401
    ...
    def test_provider_factory_module_exports_chat_litellm_class(self) -> None:
        ...
        assert hasattr(factory_module, "ChatLiteLLM"), (
            ...
            "so tests can patch it at '{{ cookiecutter.package_name }}.infra.llm.provider_factory.ChatLiteLLM'"
        )
