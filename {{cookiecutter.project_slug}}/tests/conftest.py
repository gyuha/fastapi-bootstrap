"""Root-level pytest conftest for the {{ cookiecutter.project_name }} test suite.
...
def settings_cache_clear() -> None:  # type: ignore[misc]
    ...
    :func:`~{{ cookiecutter.package_name }}.core.config.get_settings` is decorated with
    ...
    :class:`~{{ cookiecutter.package_name }}.core.config.Settings` object was built from the
