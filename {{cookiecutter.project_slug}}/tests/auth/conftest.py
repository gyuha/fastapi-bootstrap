...
class FakeAuthRepository:
    ...
    async def create_refresh_token(
        ...
        from {{ cookiecutter.package_name }}.domains.auth.security import hash_token  # noqa: PLC0415
...
def auth_service(fake_repo: FakeAuthRepository, fake_redis: FakeRedis) -> Any:
    ...
    from {{ cookiecutter.package_name }}.domains.auth.service import AuthService  # noqa: PLC0415
