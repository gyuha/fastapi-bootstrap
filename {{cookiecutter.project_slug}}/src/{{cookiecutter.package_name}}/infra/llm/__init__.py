...
Provides the :func:`~{{ cookiecutter.package_name }}.infra.llm.provider_factory.make_chat_litellm`
...
a :class:`~{{ cookiecutter.package_name }}.domains.chat.ports.LLMClientProtocol` abstraction
instead.
"""
