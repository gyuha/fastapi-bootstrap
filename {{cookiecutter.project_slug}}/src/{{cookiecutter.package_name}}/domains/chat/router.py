...
from {{ cookiecutter.package_name }}.domains.auth.security import get_current_user, require_permission
from {{ cookiecutter.package_name }}.domains.chat.container import get_chat_service
from {{ cookiecutter.package_name }}.domains.chat.repository import ChatRepository
from {{ cookiecutter.package_name }}.domains.chat.schemas import (
    ConversationCreate,
