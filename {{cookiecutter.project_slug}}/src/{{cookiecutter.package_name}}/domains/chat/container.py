...
* Registers :class:`~{{ cookiecutter.package_name }}.domains.chat.llm_client.DefaultLLMClientFactory`
...
Testing — inject a stub factory via dependency override::
    ...
    from {{ cookiecutter.package_name }}.domains.chat.container import get_llm_factory
...
def get_llm_factory() -> LLMClientFactoryProtocol:
    ...
    from {{ cookiecutter.package_name }}.domains.chat.llm_client import DefaultLLMClientFactory  # noqa: PLC0415
...
def get_chat_service(
    ...
    * **Tests** — override :func:`get_llm_factory` with a stub factory;
    ...
    :class:`~{{ cookiecutter.package_name }}.domains.chat.ports.LLMClientProtocol`, not the factory.
