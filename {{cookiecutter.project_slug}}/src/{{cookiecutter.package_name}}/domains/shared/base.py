...
:class:`~{{ cookiecutter.package_name }}.core.database.Base`.  ORM models live in each domain's
...
Usage::
    ...
    from {{ cookiecutter.package_name }}.domains.shared.base import Entity, ValueObject
...
class Entity:
    ...
    :class:`~{{ cookiecutter.package_name }}.core.database.Base` directly.
